...
# Spot
# User currency account channel
# channels = ["spot/account:USDT"]
# User margin account channel
# channels = ["spot/margin_account:BTC-USDT"]
# User delegation strategy channel
...
# Public-full contract information channel
...
# Public-Estimated delivery price channel
# channels = ["futures/estimated_price:BTC-USD-200228"]
# Public-Limited Channel
